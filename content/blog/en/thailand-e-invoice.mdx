...
3. **HQ integration**: Sales data feeds directly into core business systems / cloud accounting → HQ-grade management accounting becomes far easier.
...
- **Core business systems** (SAP B1, Oracle NetSuite): middleware connectors (Symphony, e-Tax Invoice Connector)
