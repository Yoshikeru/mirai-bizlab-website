...
export function MobileMenu() {
  ...
  // The header uses `backdrop-blur`, which establishes a CSS stacking
  // context — fixed children would be trapped inside the header box.
  // Render the overlay through a portal into <body> to escape that.
  useEffect(() => {
    setMounted(true);
  }, []);
