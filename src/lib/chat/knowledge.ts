...
3. 会計システム導入支援: PEAK / QuickBooks / Xero / freee / マネーフォワード / SAP Business One 等の選定、勘定科目・部門コードの再設計、月次クローズ自動化（最大80%）、現地スタッフ・本社経理のトレーニング。料金目安: プロジェクト 150,000 THB〜
4. 経営者向けお悩み相談（経営コンサルティング）: 経営者の悩み（数字・組織・現場）を客観的な視点で整理し、打ち手を一緒に検討。管理会計・KPI設計、月次経営レビュー同席、課題の実務への落とし込みまで伴走。料金目安: 月額 15,000 THB〜（1回 20,000 THB）
